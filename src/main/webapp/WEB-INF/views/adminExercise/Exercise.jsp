...
<head>
    ...
    <%
        ...
        List<ExerciseDTO> rList = (List<ExerciseDTO>) request.getAttribute("rList");

        //운동 정보 조회 결과 보여주기
        if (rList == null) {
            rList = new ArrayList<ExerciseDTO>();
            ...
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center rounded overflow-hidden">
                        ...
                        <h5 class="mb-0"><%=CmmUtil.nvl(rDTO.getExercise_seq())%></h5>
                        <h5 class="mb-0"><%=CmmUtil.nvl(rDTO.getExercise_name())%></h5>
                        <small><%=CmmUtil.nvl(rDTO.getExercise_met())%></small>
                        <div class="d-flex justify-content-center mt-3">
                            <a class="btn btn-square btn-primary mx-1" href="javascript:doDetail('<%=CmmUtil.nvl(rDTO.getExercise_seq())%>');" style="font-size: 12px">상세<br>보기</a>
