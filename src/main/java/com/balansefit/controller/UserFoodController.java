...
public class UserFoodController {
    ...
    public String getUserFoodList(ModelMap model) throws Exception {

        log.info(this.getClass().getName()+ ".UserFoodList start!");

        // 식품 리스트 가져오기
        List<FoodDTO> rList = userFoodService.getUserFoodList();
        ...
        log.info(this.getClass().getName()+ ".UserFoodList end!");
    ...
    public String getUserFoodInfo(HttpServletRequest request, ModelMap model) {

        log.info(this.getClass().getName() + ".c start!");
        ...
        try {
            ...
            log.info("getUserFoodInfo success!!");
